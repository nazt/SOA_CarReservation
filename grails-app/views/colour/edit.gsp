                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:colourInstance,field:'carstock','errors')}">
...
<g:link controller="carStock" params="['colour.id':colourInstance?.id]" action="create">Add CarStock</g:link>
